  ...
  return(
    <div className='mb-2 bg-[#122929] border-b-4 border-b-white'>
      <div className='max-md:flex max-md:justify-center'>
        ...
        <button id="search-btn" onClick={props.handleSearch} className='bg-orange-700 rounded-full border border-2xl font-semibold py-3 px-5 border-black'>Search</button>
       </div>
    </div>
  )}
